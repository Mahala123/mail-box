...
const CreateEmail = () => {
  ...
  const sendMailHandler = () => {
    ...
    fetch(`https://mail-box-73bc7-default-rtdb.firebaseio.com/${cleanToEmail}/inbox.json`,{
      method: 'POST',
      headers: {
    ...
    fetch(`https://mail-box-73bc7-default-rtdb.firebaseio.com/${cleanUserEmail}/sentemails.json`, {
      method: "POST",
      headers: {
        "Content-type": "application-json",
      },
